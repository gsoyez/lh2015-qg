...
gentags(level)='"Pythia {/*0.8 8.215}" "Herwig {/*0.8 2.7.1}" "Sherpa {/*0.8 2.1.1}" "Vincia {/*0.8 2.001}" "Deductor {/*0.8 1.0.2}" "Ariadne {/*0.8 5.0.{/Symbol b}}" "Dire {/*0.8 1.0.0}" "Analytic {/*0.8 NLL}" '
