...
\item \textsc{Vincia: alt $Q_E$}.  By default, \textsc{Vincia} uses a
  ...
  evolution variable for gluon emission, which 
  agrees with the logarithmic structure of the NLO
  $q\bar{q}\to qg\bar{q}$ antenna function~\cite{Hartgring:2013jma}. This variation
  ...
  ones (see, e.g., \cite{Fischer:2014bja}) and produces an increases in the separation power, mainly
  coming from increased activity in the $H\to gg$ showers. 
\end{itemize}
