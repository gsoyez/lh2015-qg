...
radiation patterns, though they are not currently
available in \textsc{Rivet}~\cite{Buckley:2010ar} and, 
to our knowledge, are not  used in any parton shower tuning strategy.   
\jdt{Placeholder for
  Peter.}  Therefore, we strongly encourage the inclusion of these
measurements in RIVET and in the the next round of parton shower
tunes.  
