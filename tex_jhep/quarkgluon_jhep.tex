...
Interestingly, there are LEP measurements that do constrain gluon radiation patterns, though to our knowledge, they are not currently used in any parton shower tuning strategy.  \jdt{Placeholder for Peter.}  Therefore, we strongly encourage the inclusion of these measurements in the next round of parton shower tunes.
