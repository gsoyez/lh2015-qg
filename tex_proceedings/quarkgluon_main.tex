...
\item \textsc{Pythia: CR2}.  \jdt{This variation seems to not be useful, right?  I've removed it from the plot.}
\item \textsc{Pythia: no rec}.  \jdt{This setting seems to not be useful, right?  I've removed it from the plot.}
\end{itemize}
...
\item \textsc{Vincia: no rec}.   \jdt{This setting seems to not be useful, right? I've removed it from the plot.}
\end{itemize}
...
The work of LL is supported in part by the MCnetITN FP7 Marie Curie Initial Training Network, contract PITN-GA-2012-315877, and the Swedish Research Council (contracts 621-2012-2283 and 621-2013-4287).
%
